...
var SlideshowLightbox = forwardRef(function (props, ref) {
  ...
  var _useState17 = useState(props.lightboxWidth ? props.lightboxWidth : "100vw"),
    lightboxModalWidth = _useState17[0];
  var _useState18 = useState(props.rightSidebarComponent ? props.rightSidebarComponent : null),
    rightSidebarComponent = _useState18[0];
  var _useState19 = useState(props.magnifyingGlass ? props.magnifyingGlass : false),
    magnifyingGlassFeature = _useState19[0];
  var _useState20 = useState(props.disableImageZoom ? props.disableImageZoom : false),
    disableZoom = _useState20[0],
    setDisableZoom = _useState20[1];
  var _useState21 = useState(props.slideshowInterval ? props.slideshowInterval : 1700),
    slideshowInterval = _useState21[0];
  var _useState22 = useState(props.rightArrowStyle ? props.rightArrowStyle : {}),
    rightArrowStyle = _useState22[0];
  var _useState23 = useState(props.leftArrowStyle ? props.leftArrowStyle : {}),
    leftArrowStyle = _useState23[0];
  var _useState24 = useState(props.maxZoomScale ? getScale(props.maxZoomScale, 24) : 8),
    maxScale = _useState24[0];
  var _useState25 = useState(props.roundedImages ? props.roundedImages : false),
    isRounded = _useState25[0],
    setIsRounded = _useState25[1];
  var _useState26 = useState(props.showControls ? props.showControls : true),
    showControls = _useState26[0],
    setShowControls = _useState26[1];
  var _useState27 = useState(props.showFullScreenIcon ? props.showFullScreenIcon : true),
    displayFullScreenIcon = _useState27[0],
    setDisplayFullScreenIcon = _useState27[1];
  var _useState28 = useState(props.showThumbnailIcon ? props.showThumbnailIcon : true),
    displayThumbnailIcon = _useState28[0],
    setDisplayThumbnailIcon = _useState28[1];
  var _useState29 = useState(props.showSlideshowIcon ? props.showSlideshowIcon : true),
    setDisplaySlideshowIcon = _useState29[1];
  var _useState30 = useState(props.showMagnificationIcons ? props.showMagnificationIcons : true),
    displayMagnificationIcons = _useState30[0],
    setDisplayMagnificationIcons = _useState30[1];
  var _useState31 = useState(props.nextArrow ? props.nextArrow : null),
    nextArrowElem = _useState31[0];
  var _useState32 = useState(props.imageComponent ? props.imageComponent : null),
    isImageComponent = _useState32[0];
  var _useState33 = useState(props.prevArrow ? props.prevArrow : null),
    prevArrowElem = _useState33[0];
  var _useState34 = useState(props.modalClose ? props.modalClose : "default"),
    modalCloseOption = _useState34[0];
  var _useState35 = useState(props.downloadImages ? props.downloadImages : false),
    showDownloadBtn = _useState35[0];
  var _useState36 = useState(props.showNavigationDots ? props.showNavigationDots : false),
    navigationDots = _useState36[0];
  var _useState37 = useState(props.metadataTimeLocale ? props.metadataTimeLocale : "en-US"),
    metadataLocale = _useState37[0];
  var _useState38 = useState(props.rtl ? props.rtl : false),
    isRTL = _useState38[0];
  var _useState39 = useState(props.framework ? props.framework : ''),
    frameworkID = _useState39[0];
  var _useState40 = useState(props.lightboxIdentifier ? props.lightboxIdentifier : false),
    lightboxIdentifier = _useState40[0];
  var _useState41 = useState(props.fullScreen ? props.fullScreen : false),
    imageFullScreen = _useState41[0];
  var _useState42 = useState(props.licenseKey ? props.licenseKey : '');
  var _useState43 = useState(props.showLoader ? props.showLoader : false),
    displayLoader = _useState43[0],
    setDisplayLoader = _useState43[1];
  var _useState44 = useState(props.controlComponent ? props.controlComponent : false),
    customControlComponent = _useState44[0];
  var _useState45 = useState(props.startingSlideIndex ? props.startingSlideIndex : 0),
    setStartingIndex = _useState45[1];
  var _useState46 = useState(props.backgroundColor ? props.backgroundColor : themes[defaultTheme].background),
    backgroundColor = _useState46[0],
    setBackgroundColor = _useState46[1];
  var _useState47 = useState(props.iconColor ? props.iconColor : null),
    iconColor = _useState47[0],
    setIconColor = _useState47[1];
  var _useState48 = useState(props.textColor ? props.textColor : themes[defaultTheme].textColor),
    textColor = _useState48[0],
    setTextColor = _useState48[1];
  var _useState49 = useState(props.showControlsBar ? props.showControlsBar : true),
    showControlsBar = _useState49[0];
  var _useState50 = useState(props.useCoverMode ? props.useCoverMode : false),
    coverMode = _useState50[0];
  var _useState51 = useState(props.displayMetadata ? props.displayMetadata : false),
  ...
  var _useState54 = useState(props.showThumbnails ? props.showThumbnails : false),
    showThumbnails = _useState54[0],
    setShowThumbnails = _useState54[1];
  var _useState55 = useState(props.animateThumbnails ? props.animateThumbnails : true),
    animatedThumbnails = _useState55[0];
  var _useState56 = useState(props.imgAnimation ? props.imgAnimation : 'imgDrag'),
    imgAnimation = _useState56[0],
    setImgAnimation = _useState56[1];
  var _useState57 = useState(props.arrowStyle ? props.arrowStyle : 'dark'),
  ...
  var _useState68 = useState(props.noWindow ? props.noWindow : false),
  ...
  var _useState73 = useState(props.thumbnailBorder ? createCustomThumbnailBorder() : themes[defaultTheme].thumbnailBorder),
